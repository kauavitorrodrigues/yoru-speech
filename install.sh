...
echo -e "  For push-to-talk dictation in Hyprland, add to hyprland.conf:\n"
echo -e "    bind = , Control_L, exec, yoru-dictate start"
echo -e "    bindr = , Control_L, exec, yoru-dictate stop\n"
echo -e "  Then: hyprctl reload"
echo -e "  See $YORU_SPEECH_DIR/packaging/hyprland/README.md for details"
echo -e "  and a less Ctrl-contested key binding.\n"
